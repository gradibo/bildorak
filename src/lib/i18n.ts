...
export const DICTIONARY = {
  ko: {
    ...
    "settings.update.label": "자동 업데이트 확인",
    "settings.update.hint": "앱을 시작할 때 새 버전이 있는지 조용히 확인해요.",
    ...
    "update.modal.title": "새 버전이 있어요: v{version}",
  ...
  en: {
    ...
    "settings.update.label": "Automatic update checks",
    "settings.update.hint": "Silently checks for a new version when the app starts.",
    ...
    "update.modal.title": "A new version is available: v{version}",
